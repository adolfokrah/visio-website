...
ForDevs.Schema = {
    ...
    defaultPropValues: {
        ...
        description: 'Break down your website into reusable React components that can be easily managed and customized for a more efficient and flexible development process.',
        image: {
            mediaHash: undefined,
