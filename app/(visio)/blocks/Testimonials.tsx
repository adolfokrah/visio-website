...
const Testimonials: Block<TestimonialsProps> = ({
  title,
  description,
  pageBlockId = "",
  testimonials,
        ...
        <List
          ...
          renderComponent={(testimonial, index) => (
            <motion.div
              ...
              className="flex flex-col p-4 items-center space-y-8 rounded-xl border border-slate-300"
            >
              <div className="flex items-center justify-between w-full font-satoshi text-white ">
                ...
                <div className="flex gap-2 items-center">
                  ...
                  <p className="text-xs">
                    <Text
                      propName={`testimonials.${index}.star`}
                      pageBlockId={pageBlockId}
                      defaultValue={`${testimonial.star}`}
                    />
                  </p>
                </div>
              </div>
              <div className="text-white  font-satoshi text-center text-xs ">
                <Text
                  propName={`testimonials.${index}.message`}
                  pageBlockId={pageBlockId}
...
Testimonials.Schema = {
  ...
  defaultPropValues: {
    ...
    description:
      "Thousands love our app - here how Visio cms makes content mangement simple",
    testimonials: [
      {
        name: "Emily Smith",
        message:
          "Visio CMS has transformed the way I manage my content. It's fast, easy, and efficient!",
        star: 5,
      },
      {
        name: "Michael Johnson",
        message:
          "Managing my website content has never been smoother. Visio CMS is simply amazing!",
        star: 5,
      },
      {
        name: "Sarah Williams",
        message:
          "The drag-and-drop functionality in Visio CMS is a lifesaver. Highly recommended!",
        star: 5,
      },
      {
        name: "David Brown",
        message:
          "Visio CMS is a powerful tool that simplifies content updates and gives me full control!",
        star: 5,
      },
    ],
  },
