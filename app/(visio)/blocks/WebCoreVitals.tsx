...
const WebCoreVitals:Block<WebCoreVitalsProps>=({title, description, pageBlockId='', image, backgroundColor})=>{
    return (
        <div className="bg-dark-900 pb-20  px-4">
            <motion.div 
            initial={{opacity: 0, scale: 0.9}}
            whileInView={{opacity: 1, scale: 1}}
            className="max-w-3xl rounded-lg border border-dark-700 p-14 mx-auto" style={{backgroundColor: getColor(backgroundColor)}}>
                ...
                <VisioImage defaultValue={image} propName="image" pageBlockId={pageBlockId}
...
WebCoreVitals.Schema={
    ...
    defaultPropValues:{
        ...
        description: 'Build high-performance apps optimized for Web Core Vitals to ensure fast, responsive, and user-friendly experiences',
        image: {
            mediaHash: undefined,
            width: 0,
            height: 0,
